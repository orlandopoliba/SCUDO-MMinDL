...
- [ ] Underfitting, overfitting, bias-variance trade-off, regularization techniques ($L^2$ regularization, dropout)
...
- [ ] Convolutional neural networks: theoretical introduction, writing the class for the `mydl` library, testing on a dataset
- [ ] Recurrent neural networks and LSTMs: theoretical introduction, writing the class for the `mydl` library, testing on a dataset
